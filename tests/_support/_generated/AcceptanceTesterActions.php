<?php  //[STAMP] 2fe7cf21ba9b308c39e0b3a0fe50a1ca
...
trait AcceptanceTesterActions
{
     ...
     * @param $link
     * @param $timeout
     * @see \Helper\ActionWrapper::amOnPage()
     */
     ...
     *
     *
     * @see \Helper\ActionWrapper::readConfigFile()
     */
    public function readConfigFile($key) {
        return $this->getScenario()->runStep(new \Codeception\Step\Action('readConfigFile', func_get_args()));
    }
     ...
     *
     *
     * @see \Helper\ActionWrapper::generateRandomString()
     */
     ...
     *
     * Conditional Assertion: Test won't be stopped on fail
     * @see \Helper\ActionWrapper::seePageHasElement()
     */
     ...
     *
     *
     * @see \Helper\ActionWrapper::waitAjaxLoad()
     */
     ...
     *
     * @param $timeout
     * @see \Helper\ActionWrapper::waitPageLoad()
     */
     ...
     * @param $element
     * Conditional Assertion: Test won't be stopped on fail
     * @see \Helper\ActionWrapper::dontSeeVisualChanges()
     */
     ...
     *
     * Conditional Assertion: Test won't be stopped on fail
     * @see \Helper\ActionWrapper::dontSeeJsError()
     */
